namespace ElastoSystem
{
    partial class MenuPrincipal
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnAjustes.Location = new Point(0, 1801);
            ...
            sbmMantenimiento.Location = new Point(0, 1577);
            ...
            btnMantenimiento.Location = new Point(0, 1541);
            ...
            sbmMaquinado.Location = new Point(0, 1417);
            ...
            btnMaquinado.Location = new Point(0, 1381);
            ...
            sbmProduccion.Controls.Add(btnOrdenesActivas);
            sbmProduccion.Controls.Add(btnOrdenProduccion);
            ...
            sbmProduccion.Size = new Size(187, 151);
            sbmProduccion.TabIndex = 13;
            // 
            // btnOrdenesActivas
            // 
            btnOrdenesActivas.Dock = DockStyle.Top;
            btnOrdenesActivas.Enabled = false;
            btnOrdenesActivas.FlatAppearance.BorderSize = 0;
            btnOrdenesActivas.FlatStyle = FlatStyle.Flat;
            btnOrdenesActivas.Font = new Font("Montserrat", 10F);
            btnOrdenesActivas.ForeColor = Color.White;
            btnOrdenesActivas.Location = new Point(0, 108);
            btnOrdenesActivas.Name = "btnOrdenesActivas";
            btnOrdenesActivas.Padding = new Padding(20, 0, 0, 0);
            btnOrdenesActivas.Size = new Size(187, 36);
            btnOrdenesActivas.TabIndex = 6;
            btnOrdenesActivas.Text = "Ordenes Activas";
            btnOrdenesActivas.TextAlign = ContentAlignment.MiddleLeft;
            btnOrdenesActivas.UseVisualStyleBackColor = true;
            btnOrdenesActivas.Visible = false;
            btnOrdenesActivas.Click += btnOrdenesActivas_Click;
            // 
            // btnOrdenProduccion
            // 
            btnOrdenProduccion.Dock = DockStyle.Top;
            btnOrdenProduccion.Enabled = false;
            btnOrdenProduccion.FlatAppearance.BorderSize = 0;
            btnOrdenProduccion.FlatStyle = FlatStyle.Flat;
            btnOrdenProduccion.Font = new Font("Montserrat", 10F);
            btnOrdenProduccion.ForeColor = Color.White;
            btnOrdenProduccion.Location = new Point(0, 72);
            btnOrdenProduccion.Name = "btnOrdenProduccion";
            btnOrdenProduccion.Padding = new Padding(20, 0, 0, 0);
            btnOrdenProduccion.Size = new Size(187, 36);
            btnOrdenProduccion.TabIndex = 5;
            btnOrdenProduccion.Text = "Orden de Producción";
            btnOrdenProduccion.TextAlign = ContentAlignment.MiddleLeft;
            ...
            panel1.Location = new Point(0, 1857);
            panel1.Name = "panel1";
            ...
            // 
            btnSolicitudFabricacion.Dock = DockStyle.Top;
            btnSolicitudFabricacion.Enabled = false;
            btnSolicitudFabricacion.FlatAppearance.BorderSize = 0;
            btnSolicitudFabricacion.FlatStyle = FlatStyle.Flat;
            btnSolicitudFabricacion.Font = new Font("Montserrat", 10F);
            btnSolicitudFabricacion.ForeColor = Color.White;
            btnSolicitudFabricacion.Location = new Point(0, 216);
            btnSolicitudFabricacion.Name = "btnSolicitudFabricacion";
            btnSolicitudFabricacion.Padding = new Padding(20, 0, 0, 0);
            btnSolicitudFabricacion.Size = new Size(187, 36);
            btnSolicitudFabricacion.TabIndex = 10;
            btnSolicitudFabricacion.Text = "Solicitud Fabricacion";
            btnSolicitudFabricacion.TextAlign = ContentAlignment.MiddleLeft;
            btnSolicitudFabricacion.UseVisualStyleBackColor = true;
            btnSolicitudFabricacion.Visible = false;
            btnSolicitudFabricacion.Click += button2_Click_2;
            // 
        ...
        private Button btnOrdenesActivas;
    }
}